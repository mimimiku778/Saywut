...
export class MockAIService {
  private topics = [
    { word: '桜', keywords: ['春', 'ピンク', '花', '日本', '咲く', '美しい', '木', '葉', '散る', '満開'] },
    { word: 'ラーメン', keywords: ['麺', 'スープ', '温かい', '食べ物', '箸', '中華', 'チャーシュー', '味噌', '醤油', '豚骨'] },
    { word: '富士山', keywords: ['山', '高い', '日本', '雪', '美しい', '静岡', '山梨', '登山', '3776', '世界遺産'] },
    { word: '電車', keywords: ['乗り物', '線路', '駅', '運転手', '切符', '通勤', '交通', 'レール', 'ホーム', '車両'] },
    { word: '猫', keywords: ['動物', '毛', 'にゃー', 'ペット', '可愛い', '爪', 'ひげ', '尻尾', '肉球', '鳴く'] },
    { word: 'スマートフォン', keywords: ['電話', '画面', 'アプリ', '携帯', 'タッチ', 'インターネット', 'カメラ', 'バッテリー', 'iOS', 'Android'] },
    { word: '寿司', keywords: ['魚', '米', '生', '日本料理', 'わさび', '醤油', '握り', 'ネタ', 'シャリ', '回転'] },
    { word: '本', keywords: ['読む', 'ページ', '文字', '知識', '図書館', '作家', '物語', '紙', '活字', '小説'] },
    { word: 'コーヒー', keywords: ['飲み物', '黒い', '苦い', 'カフェイン', '豆', '朝', '目覚め', 'カップ', 'エスプレッソ', 'ラテ'] },
    { word: '雨', keywords: ['水', '空', '雲', '濡れる', '傘', '梅雨', '天気', '音', 'しずく', '降る'] },
    { word: 'ピアノ', keywords: ['楽器', '鍵盤', '音楽', '白', '黒', '弾く', 'クラシック', '指', '練習', 'メロディー'] },
    { word: '海', keywords: ['水', '塩', '青い', '波', '魚', '泳ぐ', '砂浜', '深い', '広い', '潮'] }
  ];
  ...
  async generateResponse(userInput: string, correctAnswer: string): Promise<AIResponse> {
    ...
    if (topic) {
      ...
      // 部分的な文字列マッチもチェック
      const partialMatches = topic.keywords.filter(keyword =>
        keyword.toLowerCase().split('').some(char => input.includes(char)) ||
